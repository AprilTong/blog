    ...
    <div class="u-valine">
        <span class="leancloud-visitors" data-flag-title="Your Article Title">
            <span class="stat update-time">
                <img
                    class="icon"
                    src="https://raw.githubusercontent.com/AprilTong/image/master/img/update-time.png"
                />{{ $page.lastUpdated }}
            </span>

            <span class="stat read-count">
                <img class="icon" src="https://raw.githubusercontent.com/AprilTong/image/master/img/read-count.png" />
    ...
    export default {
        ...
        methods: {
            initValine() {
                ...
                this.valine.init({
                    el: '#vcomments',
                    appId: 'FznJOMagtkw64QLRiC0jbItB-gzGzoHsz', // your appId
                    appKey: 'vUdn3KYiPCVR0sztolpWBPBF', // your appKey
                    notify: false,
                    verify: false,
                    path,
                    visitor: true,
